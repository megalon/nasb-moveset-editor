...
namespace NASB_Moveset_Editor.FloatSources
{
	public class FSCameraInfoNode : FloatSourceNode
	{
		...
		public MovesetParser.FloatSources.FSCameraInfo.CameraAttribute Attribute;
		...
		public int SetData(FSCameraInfo data, MovesetGraph graph, string assetPath, UnityEngine.Vector2 nodeDepthXY)
		{
		...
		public new FSCameraInfo GetData()
		{
			...
			objToReturn.TID = TypeId.FSCameraInfo;
