...
namespace NASB_Moveset_Editor.FloatSources
{
	...
	{
		public MovesetParser.FloatSources.FSMovement.MovementAttribute Attribute;
		...
		public int SetData(FSMovement data, MovesetGraph graph, string assetPath, UnityEngine.Vector2 nodeDepthXY)
		{
		...
		public new FSMovement GetData()
		{
			...
			objToReturn.TID = TypeId.FSMovement;
