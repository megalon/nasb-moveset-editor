...
namespace NASB_Moveset_Editor.FloatSources
{
	public class FSInputNode : FloatSourceNode
	{
		...
		public MovesetParser.FloatSources.FSInput.CheckInput Input;
		...
		public int SetData(FSInput data, MovesetGraph graph, string assetPath, UnityEngine.Vector2 nodeDepthXY)
		{
		...
		public new FSInput GetData()
		{
			...
			objToReturn.TID = TypeId.FSInput;
