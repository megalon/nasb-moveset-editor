...
namespace NASB_Moveset_Editor.FloatSources
{
	public class FSSportsNode : FloatSourceNode
	{
		...
		public MovesetParser.FloatSources.FSSports.Attributes Attribute;
		...
		public int SetData(FSSports data, MovesetGraph graph, string assetPath, Vector2 nodeDepthXY)
		{
		...
		public new FSSports GetData()
		{
			...
			objToReturn.TID = TypeId.SportsId;
