...
namespace NASB_Moveset_Editor.FloatSources
{
	public class FSModeNode : FloatSourceNode
	{
		...
		public MovesetParser.FloatSources.FSMode.Attributes Attribute;
		...
		public int SetData(FSMode data, MovesetGraph graph, string assetPath, Vector2 nodeDepthXY)
		{
