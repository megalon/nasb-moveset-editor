...
namespace NASB_Moveset_Editor.ObjectSources
{
	public class ObjectSourceNode : BaseMovesetNode
	{
		...
		public int SetData(ObjectSource data, MovesetGraph graph, string assetPath, UnityEngine.Vector2 nodeDepthXY)
		{
		...
		public ObjectSource GetData()
		{
			...
			objToReturn.TID = TypeId.ObjectSource;
			objToReturn.TID = TID;
			return objToReturn;
		}
	}
