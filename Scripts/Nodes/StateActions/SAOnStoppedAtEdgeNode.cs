...
{
	public class SAOnStoppedAtEdgeNode : StateActionNode
	{
		...
		public int SetData(SAOnStoppedAtEdge data, MovesetGraph graph, string assetPath, UnityEngine.Vector2 nodeDepthXY)
		{
			name = NodeEditorUtilities.NodeDefaultName(typeof(SAOnStoppedAtEdge));
		...
		public new SAOnStoppedAtEdge GetData()
		{
			SAOnStoppedAtEdge objToReturn = new SAOnStoppedAtEdge();
			objToReturn.TID = TypeId.SAOnStoppedAtEdge;
