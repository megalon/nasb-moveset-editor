...
namespace NASB_Moveset_Editor.StateActions
{
	public class SAPlaySFXTimelineNode : StateActionNode
	{
		...
		public int SetData(SAPlaySFXTimeline data, MovesetGraph graph, string assetPath, Vector2 nodeDepthXY)
		{
		...
		public new SAPlaySFXTimeline GetData()
		{
			...
			objToReturn.TID = TypeId.SFXTimelineId;
