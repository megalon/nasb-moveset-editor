...
namespace NASB_Moveset_Editor.StateActions
{
	public class SAManipDecorChainNode : StateActionNode
	{
		...
		public MovesetParser.StateActions.SAManipDecorChain.ManipType Manip;
		[Output(connectionType = ConnectionType.Override)] public FloatSource Source;
		
		protected override void Init()
		{
			base.Init();
			TID = TypeId.ManipDecorChainId;
		}
		...
		public int SetData(SAManipDecorChain data, MovesetGraph graph, string assetPath, Vector2 nodeDepthXY)
		{
		...
		public new SAManipDecorChain GetData()
		{
			...
			objToReturn.TID = TypeId.ManipDecorChainId;
