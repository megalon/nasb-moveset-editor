...
{
	public class SAOnLandNode : StateActionNode
	{
		...
		public int SetData(SAOnLand data, MovesetGraph graph, string assetPath, UnityEngine.Vector2 nodeDepthXY)
		{
			name = NodeEditorUtilities.NodeDefaultName(typeof(SAOnLand));
		...
		public new SAOnLand GetData()
		{
			SAOnLand objToReturn = new SAOnLand();
			objToReturn.TID = TypeId.SAOnLand;
