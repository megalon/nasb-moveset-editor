...
namespace NASB_Moveset_Editor.StateActions
{
	public class SAOnStoppedAtLedgeNode : StateActionNode
	{
		...
		public int SetData(SAOnStoppedAtLedge data, MovesetGraph graph, string assetPath, Vector2 nodeDepthXY)
		{
			name = NodeEditorUtilities.NodeDefaultName(typeof(SAOnStoppedAtLedge));
		...
		public new SAOnStoppedAtLedge GetData()
		{
			SAOnStoppedAtLedge objToReturn = new SAOnStoppedAtLedge();
			objToReturn.TID = TypeId.OnStoppedAtEdgeId;
