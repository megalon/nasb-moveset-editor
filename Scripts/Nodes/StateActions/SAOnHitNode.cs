...
namespace NASB_Moveset_Editor.StateActions
{
	public class SAOnHitNode : StateActionNode
	{
		...
		public int SetData(SAOnHit data, MovesetGraph graph, string assetPath, UnityEngine.Vector2 nodeDepthXY)
		{
			name = NodeEditorUtilities.NodeDefaultName(typeof(SAOnHit));
		...
		public new SAOnHit GetData()
		{
			SAOnHit objToReturn = new SAOnHit();
			objToReturn.TID = TypeId.SAOnHit;
