...
namespace NASB_Moveset_Editor.StateActions
{
	public class SADeactivateInputActionNode : StateActionNode
	{
		...
		public int SetData(SADeactivateInputAction data, MovesetGraph graph, string assetPath, UnityEngine.Vector2 nodeDepthXY)
		{
		...
		public new SADeactivateInputAction GetData()
		{
			...
			objToReturn.TID = TypeId.SADeactivateInputAction;
			objToReturn.Id = Id;
			return objToReturn;
		}
	}
