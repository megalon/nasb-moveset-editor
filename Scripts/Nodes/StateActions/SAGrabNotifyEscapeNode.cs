...
namespace NASB_Moveset_Editor.StateActions
{
	public class SAGrabNotifyEscapeNode : StateActionNode
	{
		...
		public int SetData(SAGrabNotifyEscape data, MovesetGraph graph, string assetPath, UnityEngine.Vector2 nodeDepthXY)
		{
		...
		public new SAGrabNotifyEscape GetData()
		{
			...
			objToReturn.TID = TypeId.SAGrabNotifyEscape;
			return objToReturn;
		}
	}
}
