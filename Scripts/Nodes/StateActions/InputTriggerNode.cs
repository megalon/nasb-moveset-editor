...
using static MovesetParser.StateActions.InputTrigger;
...
namespace NASB_Moveset_Editor.StateActions
{
	public class InputTriggerNode : StateActionNode
	{
		...
		public int SetData(InputTrigger data, MovesetGraph graph, string assetPath, Vector2 nodeDepthXY)
		{
			...
			variableCount += node_Validator.SetData(Validator, graph, assetPath, nodeDepthXY + new Vector2(1, variableCount));
