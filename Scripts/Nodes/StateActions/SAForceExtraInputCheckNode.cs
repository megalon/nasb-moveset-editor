...
namespace NASB_Moveset_Editor.StateActions
{
	public class SAForceExtraInputCheckNode : StateActionNode
	{
		...
		public int SetData(SAForceExtraInputCheck data, MovesetGraph graph, string assetPath, UnityEngine.Vector2 nodeDepthXY)
		{
		...
		public new SAForceExtraInputCheck GetData()
		{
			...
			objToReturn.TID = TypeId.SAForceExtraInputCheck;
			return objToReturn;
		}
	}
}
