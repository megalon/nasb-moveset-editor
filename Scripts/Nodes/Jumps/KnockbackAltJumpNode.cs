...
{
	public class KnockbackAltJumpNode : JumpNode
	{
		...
		public int SetData(KnockbackAltJump data, MovesetGraph graph, string assetPath, Vector2 nodeDepthXY)
		{
			name = NodeEditorUtilities.NodeDefaultName(typeof(KnockbackAltJump));
		...
		public new KnockbackAltJump GetData()
		{
			KnockbackAltJump objToReturn = new KnockbackAltJump();
			objToReturn.TID = TypeId.KnockbackAltId;
