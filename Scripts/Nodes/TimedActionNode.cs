...
namespace NASB_Moveset_Editor
{
	public class TimedActionNode : BaseMovesetNode
	{
		...
		public int SetData(TimedAction data, MovesetGraph graph, string assetPath, UnityEngine.Vector2 nodeDepthXY)
		{
			name = NodeEditorUtilities.NodeDefaultName(typeof(TimedAction));
